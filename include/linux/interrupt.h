 ...
 * IRQF_STRONG_AFFINE - Interrupt is critical to the overall performance of the
 *		       system and should be processed on a big or prime CPU.
 */
...
#define IRQF_STRONG_AFFINE	0x00120000
