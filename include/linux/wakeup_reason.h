...
struct wakeup_irq_node {
	 ...
	 * handle_.*_irq in kernel/irq/handle.c) for this node gets called; it
	 * is set to false otherwise.  We use this flag to determine whether a
	 * subtree rooted at a node has been handled.  When all trees rooted at
